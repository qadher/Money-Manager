...
import 'package:moneywallet/screen/settings/view/widgets/screen_support.dart';
import 'package:provider/provider.dart';
import 'package:sizer/sizer.dart';
import 'package:share/share.dart';

import '../../../widget/reminder/reminder_local_notification.dart';
        ...
        child: Column(
          children: [
            ListTile(
              ...
              trailing: Consumer(
                builder: (BuildContext context, SettingsProvider switchdata, Widget? child) {
                  return Switch(
            ...
            ListTile(
              ...
              onTap: () {
                Share.share('Money Manager\n, https://play.google.com/store/apps/details?id=com.halcyon.moneymanager');
              },
            ),
            ListTile(
